...
| Step | Pages |
|---|---|
| 1. Contain the agent before it touches your code | [No-regret measures](/sandbox/no-regret-measures/), the six things that must hold before the first run; [AppSec shell](/sandbox/sbx-shell/), the wrapper that implements them on Docker sbx |
